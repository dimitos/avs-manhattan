<?
    ...
    class Referer
    {
        ...
        private function convert_input(): void
        {
            ...
            if (in_array($this->utm_original->utm_source, ["v1", "v2", "v1-krd", "v2-krd", "v1-ufo", "v2-ufo", "v1-rus", "v2-rus", "intop-sales-v1", "intop-sales-v2", "intop-sales-v3", "intop-sales-v4", "intop-sales-v5", "soc"])) {
                ...
                if ($this->utm_original->utm_source == "soc") {
                    ...
                    if (preg_match("/^ga-.+/", $this->utm_original->utm_campaign)) {
                        $this->utm_intop->utm_source = "Google Ads Поиск";
                    } elseif (preg_match("/^yd-.+/", $this->utm_original->utm_campaign)) {
                        $this->utm_intop->utm_source = "Яндекс Директ Поиск";
                    } elseif (preg_match("/^rsya-.+/", $this->utm_original->utm_campaign)) {
                        $this->utm_intop->utm_source = "Яндекс Директ РСЯ";
                    } else {
                        $this->utm_intop->utm_source = "Интернет-реклама";
                    }

                    if (preg_match("/.+-krd$/", $this->utm_original->utm_campaign)) {
                        $this->ref_type = "krd";
                        $this->utm_intop->utm_campaign = "Краснодарский край";
                    } elseif (preg_match("/.+-anapa$/", $this->utm_original->utm_campaign)) {
                        $this->ref_type = "anapa";
                        $this->utm_intop->utm_campaign = "Анапа";
